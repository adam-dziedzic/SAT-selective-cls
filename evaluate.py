...
parser.add_argument('--resume_path', type=str,
                    default="/datadrive1/adam/cifar10-vgg16_bn/seed-24-epoch-300.pth",
...
def main():
    ...
    if args.evaluate:
        ...
        validate(val_loader=testloader, model=model)

        test_loss, test_acc = test(testloader, model, criterion, args.epochs,
                                   use_cuda, evaluation=True)
